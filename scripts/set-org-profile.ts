...
const REVAMPIT_PROFILE: OrgProfile = {
  identity: {
    mission: 'Reduce e-waste and bridge the digital divide by refurbishing donated IT equipment and providing it to people who need it.',
    legalForm: 'Non-profit association (Verein)',
    founded: '2012',
    location: 'Winterthur, Switzerland',
    website: 'https://revampit.ch',
    description: 'Revamp-IT is a social enterprise that collects donated computers and electronics, professionally refurbishes them with Linux, and sells them at affordable prices. We provide IT training, repair services, and digital inclusion programs. We operate as a non-profit with a team of volunteers and staff funded through sales, donations, and grants.',
  },
  services: [
    {
      name: 'Refurbished Computers',
      description: 'Professionally refurbished laptops and desktops with Linux pre-installed, tested and quality-checked',
      pricing: 'CHF 50-250 depending on specs',
    },
    {
      name: 'IT Repair & Support',
      description: 'Computer repair, data recovery, virus removal, hardware upgrades for individuals and small businesses',
      pricing: 'CHF 60/hour',
    },
    {
      name: 'IT Training & Workshops',
      description: 'Linux workshops, digital literacy courses, basic computer skills for seniors and newcomers',
      pricing: 'Free or low-cost (grant-funded)',
    },
    {
      name: 'Corporate IT Recycling',
      description: 'Secure data destruction and professional IT asset disposal for companies, with certificates of destruction',
      pricing: 'Free pickup for donations, commercial rates for certified destruction',
    },
    {
      name: 'Custom IT Solutions',
      description: 'Server setup, network configuration, and IT consulting for small businesses and non-profits',
  ...
  team: [
    ...
    },
    {
      ...
      responsibilities: 'Hardware testing, software installation, quality control, customer support',
    },
  ],
  financialContext: {
    fundingSources: ['Product sales', 'Repair services', 'Donations', 'Grants', 'Corporate sponsorships'],
    revenueModel: 'Hybrid: earned income from sales/services + philanthropic funding from grants/donations. Self-sustaining target is 70% earned income.',
    fiscalYearEnd: '31.12',
    notes: '0% VAT (non-profit exemption). All revenue reinvested into the mission. Funded positions through employment programs (RAV/IV/Sozialhilfe).',
  },
  impactMetrics: [
  ...
  strategy: {
    vision: 'By 2030, Revamp-IT is the leading Swiss social enterprise for circular IT, operating in multiple cities with a sustainable business model that scales digital inclusion nationwide.',
    goals: [
  ...
  communicationStyle: {
    ...
    guidelines: 'Always emphasize the dual impact: environmental (e-waste reduction) AND social (digital inclusion). Use concrete numbers when possible. Our audience ranges from corporate IT managers to individual customers to grant-making foundations.',
  },
  customerSegments: [
    {
      segment: 'Individual buyers',
      description: 'Budget-conscious individuals, students, seniors, and newcomers looking for affordable, reliable computers',
    },
    {
      segment: 'Corporate IT donors',
      description: 'Companies replacing IT equipment who want responsible recycling with social impact and data destruction certificates',
    },
    {
      segment: 'Small businesses & non-profits',
      description: 'Organizations needing affordable IT solutions, repair services, or bulk refurbished equipment',
    },
    {
      segment: 'Social service referrals',
      description: 'People referred by social services (Sozialhilfe, IV, refugee services) who need free or subsidized computers',
    },
    {
...
async function main(): Promise<void> {
  ...
  console.log(`  Profile sections: ${Object.keys(REVAMPIT_PROFILE).filter(k => REVAMPIT_PROFILE[k as keyof OrgProfile]).length}`);
  console.log('Done.');
