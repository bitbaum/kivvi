...
export const KIVITENDO_PRODUCT_PROFILE: MappingProfile = {
  ...
  fields: [
    ...
    {
      source: "Einkaufspreis",
      target: "purchasePrice",
      transform: "swissNumber",
    },
...
export const KIVITENDO_SALES_ORDER_PROFILE: MappingProfile = {
  name: "Kivitendo Sales Orders",
  entityType: "order",
  signatureColumns: ["Auftrag", "Kundennummer", "Offen"],
  fields: [
    { source: "Buchungsnummer", target: "number", transform: "trim" },
    { source: "Auftrag", target: "legacyNumber", transform: "trim" },
    { source: "Datum", target: "issueDate", transform: "swissDate" },
    { source: "Lieferdatum", target: "deliveryDate", transform: "swissDate" },
    { source: "Kundennummer", target: "contactNumber", transform: "trim" },
    { source: "Kunde", target: "contactName", transform: "trim" },
    ...
    { source: "Steuer", target: "vatAmount", transform: "swissNumber" },
    { source: "Summe", target: "total", transform: "swissNumber" },
    { source: "Offen", target: "isOpen", transform: "trim" },
    { source: "Interne Bemerkungen", target: "notes", transform: "trim" },
    { source: "Positionen", target: "positions", transform: "trim" },
    { source: "Steuersatz", target: "vatRate", transform: "swissNumber" },
  ],
};

export const KIVITENDO_QUOTE_PROFILE: MappingProfile = {
  name: "Kivitendo Quotes",
  entityType: "quote",
  signatureColumns: ["Angebot", "Gültig bis", "Kundennummer"],
  fields: [
    { source: "Buchungsnummer", target: "number", transform: "trim" },
    { source: "Angebot", target: "legacyNumber", transform: "trim" },
    { source: "Datum", target: "issueDate", transform: "swissDate" },
    { source: "Gültig bis", target: "dueDate", transform: "swissDate" },
    { source: "Kundennummer", target: "contactNumber", transform: "trim" },
    { source: "Kunde", target: "contactName", transform: "trim" },
    { source: "Betrag", target: "subtotal", transform: "swissNumber" },
    { source: "Steuer", target: "vatAmount", transform: "swissNumber" },
...
export const KIVITENDO_DELIVERY_NOTE_PROFILE: MappingProfile = {
  name: "Kivitendo Delivery Notes",
  entityType: "delivery_note",
  signatureColumns: ["Lieferschein", "Lieferscheindatum", "Geliefert"],
  fields: [
    { source: "Buchungsnummer", target: "number", transform: "trim" },
    { source: "Lieferschein", target: "legacyNumber", transform: "trim" },
    {
      source: "Lieferscheindatum",
      target: "issueDate",
      transform: "swissDate",
    },
    { source: "Liefertermin", target: "deliveryDate", transform: "swissDate" },
    { source: "Kundennummer", target: "contactNumber", transform: "trim" },
    { source: "Kunde", target: "contactName", transform: "trim" },
    { source: "Auftrag", target: "orderNumber", transform: "trim" },
    { source: "Geliefert", target: "isDelivered", transform: "trim" },
    { source: "Positionen", target: "positions", transform: "trim" },
  ],
};
...
const ALL_PROFILES: MappingProfile[] = [
  ...
  KIVITENDO_SALES_ORDER_PROFILE,
  KIVITENDO_QUOTE_PROFILE,
  KIVITENDO_DELIVERY_NOTE_PROFILE,
