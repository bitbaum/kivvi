...
describe("isValidTransition", () => {
  ...
  it("draft → confirmed (valid — intake/purchase_invoice skip sent)", () => {
    // draft → confirmed is intentionally allowed for intake documents and
    // purchase invoices that do not go through a "sent" stage.
