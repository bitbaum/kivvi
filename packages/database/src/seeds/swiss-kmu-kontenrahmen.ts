...
export const SWISS_KMU_ACCOUNTS: SeedAccount[] = [
  ...
  { code: '1100', name: 'Forderungen aus Lieferungen und Leistungen (Debitoren)', type: 'asset' },
  { code: '1109', name: 'Delkredere (Wertberichtigung Forderungen)', type: 'asset' },
  { code: '1140', name: 'Vorschüsse und Darlehen', type: 'asset' },
  { code: '1170', name: 'Vorsteuer auf Materialaufwand und DL', type: 'asset' },
  { code: '1171', name: 'Vorsteuer auf Investitionen und übrigem Aufwand', type: 'asset' },
  { code: '1176', name: 'Verrechnungssteuer', type: 'asset' },
  { code: '1180', name: 'Sonstige kurzfristige Forderungen', type: 'asset' },
  { code: '1190', name: 'Aktive Rechnungsabgrenzung (Transitorische Aktiven)', type: 'asset' },
  ...
  { code: '1250', name: 'Angefangene Arbeiten (nicht fakturierte DL)', type: 'asset' },
  ...
  { code: '2000', name: 'Verbindlichkeiten aus Lieferungen und Leistungen (Kreditoren)', type: 'liability' },
  { code: '2030', name: 'Erhaltene Anzahlungen', type: 'liability' },
  { code: '2050', name: 'Kontokorrent Bank (kurzfristig)', type: 'liability' },
  { code: '2100', name: 'Geschuldete MWST (Umsatzsteuer)', type: 'liability' },
  { code: '2110', name: 'Fällige MWST (Abrechnungskonto)', type: 'liability' },
  { code: '2120', name: 'Direkte Steuern', type: 'liability' },
  { code: '2140', name: 'Übrige kurzfristige Verbindlichkeiten', type: 'liability' },
  ...
  { code: '2200', name: 'Passive Rechnungsabgrenzung (Transitorische Passiven)', type: 'liability' },
  { code: '2210', name: 'Kurzfristige Rückstellungen', type: 'liability' },
  { code: '2260', name: 'Kurzfristige Bankverbindlichkeiten', type: 'liability' },

  // 24xx — Long-term Liabilities (Langfristiges Fremdkapital)
  { code: '2400', name: 'Langfristige Bankverbindlichkeiten', type: 'liability' },
  ...
  { code: '3600', name: 'Bestandesänderungen Halb- und Fertigfabrikate', type: 'revenue' },
  ...
  { code: '4400', name: 'Aufwand für bezogene Drittleistungen', type: 'expense' },
  ...
  { code: '6100', name: 'Unterhalt, Reparaturen, Ersatz (Mobiliar)', type: 'expense' },
  { code: '6105', name: 'Unterhalt, Reparaturen, Ersatz (Werkzeuge)', type: 'expense' },
  ...
  { code: '6210', name: 'Abschreibungen Mobiliar und Einrichtungen', type: 'expense' },
  { code: '6220', name: 'Abschreibungen Büromaschinen und Informatik', type: 'expense' },
  ...
  { code: '6540', name: 'Mitgliederbeiträge und Verbandsbeiträge', type: 'expense' },
  ...
  { code: '6700', name: 'Beratungsaufwand (Treuhänder, Rechtsanwalt)', type: 'expense' },
  ...
  { code: '7000', name: 'Betriebsfremder Aufwand Liegenschaften', type: 'expense' },
  { code: '7010', name: 'Betriebsfremder Ertrag Liegenschaften', type: 'revenue' },
