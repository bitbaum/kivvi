        ...
        <div className="rounded-xl border bg-card p-6">
          <div className="flex items-end gap-3">
            <div className="flex-1">
              <label className="mb-1.5 block text-sm font-medium">{t('tokenName')}</label>
              <input
                type="text"
                value={newTokenName}
              ...
              <div className="flex items-center gap-2">
                {token.isActive && (
                  <button
                    ...
                    className="flex items-center gap-1 rounded-lg border px-3 py-1.5 text-xs font-medium text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/10"
                  >
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg border px-3 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/10"
                >
