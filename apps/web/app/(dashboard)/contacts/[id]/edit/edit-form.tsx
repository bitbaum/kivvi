      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="rounded-xl border bg-card">
          ...
          <div className="grid gap-6 p-6 sm:grid-cols-2">
            ...
            <div>
              <label htmlFor="mobile" className="mb-1.5 block text-sm font-medium">Mobile</label>
        ...
        <section className="rounded-xl border bg-card">
          ...
          <div className="grid gap-6 p-6 sm:grid-cols-2">
            <div className="sm:col-span-2">
              <label htmlFor="address" className="mb-1.5 block text-sm font-medium">Street Address</label>
        ...
        <section className="rounded-xl border bg-card">
          ...
          <div className="grid gap-6 p-6 sm:grid-cols-2">
            <div>
              <label htmlFor="vatNumber" className="mb-1.5 block text-sm font-medium">VAT Number</label>
            ...
            <div>
              <label htmlFor="iban" className="mb-1.5 block text-sm font-medium">IBAN</label>
            ...
            <div>
              <label htmlFor="paymentTermsDays" className="mb-1.5 block text-sm font-medium">Payment Terms (days)</label>
            ...
            <div>
              <label htmlFor="creditLimit" className="mb-1.5 block text-sm font-medium">Credit Limit (CHF)</label>
